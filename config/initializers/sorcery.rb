...
Rails.application.config.sorcery.submodules = [:external, :activity_logging] #:remember_me, :reset_password, :user_activation]
...
Rails.application.config.sorcery.configure do |config|
  ...
  config.twitter.key = CHAMPTRACKER_CONFIG[:twitter][:key]
  config.twitter.secret = CHAMPTRACKER_CONFIG[:twitter][:secret]
  config.twitter.callback_url = CHAMPTRACKER_CONFIG[:twitter][:callback_url]
  config.twitter.user_info_mapping = CHAMPTRACKER_CONFIG[:twitter][:user_info_mapping]

  config.facebook.key = CHAMPTRACKER_CONFIG[:facebook][:key]
  config.facebook.secret = CHAMPTRACKER_CONFIG[:facebook][:secret]
  config.facebook.callback_url = CHAMPTRACKER_CONFIG[:facebook][:callback_url]
  config.facebook.user_info_mapping = CHAMPTRACKER_CONFIG[:facebook][:user_info_mapping]
  config.facebook.access_permissions = CHAMPTRACKER_CONFIG[:facebook][:access_permissions]
  config.facebook.user_info_path = CHAMPTRACKER_CONFIG[:facebook][:user_info_path]
  ...
  config.google.key = CHAMPTRACKER_CONFIG[:google][:key]
  config.google.secret = CHAMPTRACKER_CONFIG[:google][:secret]
  config.google.callback_url = CHAMPTRACKER_CONFIG[:google][:callback_url]
  config.google.user_info_mapping = CHAMPTRACKER_CONFIG[:google][:user_info_mapping]
